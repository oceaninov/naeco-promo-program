...
func request_ProgramService_ProgramStatusUpdate_0(ctx context.Context, marshaler runtime.Marshaler, client ProgramServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ProgramStatusUpdateRes
	var metadata runtime.ServerMetadata
	...
	msg, err := client.ProgramStatusUpdate(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ProgramService_ProgramStatusUpdate_0(ctx context.Context, marshaler runtime.Marshaler, server ProgramServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ProgramStatusUpdateRes
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ProgramStatusUpdate(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterProgramServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ProgramServiceServer) error {
	...
	mux.Handle("POST", pattern_ProgramService_ProgramStatusUpdate_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/api.v1.ProgramService/ProgramStatusUpdate", runtime.WithHTTPPathPattern("/v1/program/status-update"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ProgramService_ProgramStatusUpdate_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_ProgramService_ProgramStatusUpdate_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterProgramServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ProgramServiceClient) error {
	...
	mux.Handle("POST", pattern_ProgramService_ProgramStatusUpdate_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/api.v1.ProgramService/ProgramStatusUpdate", runtime.WithHTTPPathPattern("/v1/program/status-update"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ProgramService_ProgramStatusUpdate_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_ProgramService_ProgramStatusUpdate_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "program", "status-update"}, ""))
...
var (
	...
	forward_ProgramService_ProgramStatusUpdate_0 = runtime.ForwardResponseMessage
