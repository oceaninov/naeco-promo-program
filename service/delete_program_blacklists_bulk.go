...
func (s service) DeleteProgramBlacklistsBulk(ctx context.Context, req *pb.Blacklisting) (res *emptypb.Empty, err error) {
	const funcName = `DeleteProgramBlacklistsBulk`
	...
	err = s.repo.ReadWriter.RemoveProgramBlacklistBulk(ctx, req)
	if err != nil {
